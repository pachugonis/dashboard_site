...
# где лежат onionwatch.py, dashboard.html, news.html, stats.html, onionwatch.service, config.example.json.
#
...
for f in onionwatch.py dashboard.html admin.html news.html stats.html onionwatch.service config.example.json; do
...
install -o root -g root -m 0644 "${SRC_DIR}/stats.html"     "${APP_DIR}/stats.html"
